...
public class Inscripciones_Pendientes extends javax.swing.JFrame {
    ...
    //Metodo constructor
    public Inscripciones_Pendientes() {
    ...
    private void ConstruirTabla(){
        ...
        DefaultTableModel modelo=new DefaultTableModel(
                ...
                new Object[]{"id","Nombre","Fecha","Cantidad","Restante","",""}
        )
        {
    ...
    private void Obtenerinscripciones(){
        int contador=0;
        inscripciones=crud1.getTypeInscripciones("Incompleto");
        //Recorridos de los grupos
        for (Inscripciones i:inscripciones){
            this.filas[contador][0]=i.getIdInscripciones();
            this.filas[contador][1]=i.getNombre()+" "+i.getApellidos();
            this.filas[contador][2]=i.getFecha();
            this.filas[contador][3]=i.getCantidad();
            this.filas[contador][4]=Math.abs(Integer.parseInt(i.getCantidad())-Integer.parseInt(costo[1].toString()));
            this.filas[contador][5]=(Object) modificar;
            this.filas[contador][6]=(Object) eliminar;
    ...
    private void ObtenerCosto(){
        this.costo=crud1.getCosto("Inscripcion");
        cuota.setText("$ "+costo[1].toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Cuota de Inscripcion:");
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        //Obtener el numero de la columna selecionada
        int columna=tabla.getColumnModel().getColumnIndexAtX(evt.getX());
        //Obtener el numero de la fila selecionada
        ...
        if(fila<tabla.getRowCount()&&fila>=0&&columna<tabla.getColumnCount()&&columna>=0){
            ...
            if(valor instanceof JButton){
                ...
                if(boton.getName().equals("m")){
                    //Construccion del objeto de Inscripcion Abonar
                    Inscripciones_Abonar a=new Inscripciones_Abonar(Integer.parseInt(inscripciones.get(fila).getIdInscripciones()),inscripciones.get(fila).getNombre(),inscripciones.get(fila).getApellidos(),inscripciones.get(fila).getFecha(),inscripciones.get(fila).getCantidad(),inscripciones.get(fila).getObservaciones() ,Math.abs(Integer.parseInt(inscripciones.get(fila).getCantidad())-Integer.parseInt(costo[1].toString())));
                    a.setVisible(true);
                    this.setVisible(false);
                }else if(boton.getName().equals("e")){
                   crud1.deleteInscripcion(id);
                   this.ConstruirTabla();
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Inscripciones_Pendientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Inscripciones_Pendientes().setVisible(true);
            }
        });
    }
