...
public class Grupos_Actualizar extends javax.swing.JFrame {
    int idSelect;
    Crud crud1 = new Crud();

    public Grupos_Actualizar() {
    ...
    //Metodo constructor    
    public Grupos_Actualizar(int id) {
        this.idSelect=id;
        Date fechaActual = new Date();
        initComponents();
        String fecha1 = fechaActual.getDate() + "/" + fechaActual.getMonth() + 1 + "/" + (fechaActual.getYear() - 100);
    ...
    private void initComponents() {
        ...
        btnAlumnos8.setForeground(new java.awt.Color(204, 204, 204));
        ...
        btnAlumnos6.setText("Actualizar");
        ...
        grupo.setFont(new java.awt.Font("Malayalam MN", 0, 14)); // NOI18N
        grupo.setForeground(new java.awt.Color(204, 204, 204));
        grupo.setText("Ingrese el grupo");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(semestre, javax.swing.GroupLayout.DEFAULT_SIZE, 163, Short.MAX_VALUE)
                            .addComponent(jSeparator1))
                        .addGap(183, 183, 183)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jSeparator2)
                            .addComponent(grupo, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE))
                        .addGap(64, 64, 64))
                    .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void btnAlumnos6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlumnos6ActionPerformed
        Crud crud1=new Crud();
        crud1.updateGrupo(this.idSelect, Integer.parseInt(semestre.getText()), grupo.getText());
        semestre.setText("");
        grupo.setText("");
    ...
    private void semestreMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_semestreMousePressed
        semestre.setText("");
        semestre.setForeground(new Color(0,0,0));
    }//GEN-LAST:event_semestreMousePressed

    private void grupoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grupoMousePressed
        grupo.setText("");
        grupo.setForeground(new Color(0,0,0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Grupos_Actualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grupos_Actualizar().setVisible(true);
            }
        });
    }
