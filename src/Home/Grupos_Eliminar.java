...
public class Grupos_Eliminar extends javax.swing.JFrame {
    ...
    private void Obtenergrupos(){
        int contador=0;
        ArrayList<Grupos> grupos=new ArrayList<>();
        grupos=crud1.getGrupos();
        //Recorridos de los grupos
        for (Grupos g:grupos){
            this.filas[contador][0]=(Object) g.getId();
            this.filas[contador][1]=(Object) g.getSemestre();
            this.filas[contador][2]=(Object) g.getGrupo();
        ...
        if(fila<tabla.getRowCount()&&fila>=0&&columna<tabla.getColumnCount()&&columna>=0){
            ...
            if(valor instanceof JButton){
                ...
                if(boton.getName().equals("m")){
                    Grupos_Actualizar g=new Grupos_Actualizar(id);
                    g.setVisible(true);
                    this.setVisible(false); 
                }else if(boton.getName().equals("e")){
                   crud1.deleteGrupo(id);
                   this.ConstruirTabla();
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Grupos_Eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grupos_Eliminar().setVisible(true);
            }
        });
    }
