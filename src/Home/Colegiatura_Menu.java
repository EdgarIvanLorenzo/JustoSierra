...
public class Colegiatura_Menu extends javax.swing.JFrame {

    //Metodo constructor
    public Colegiatura_Menu() {
    ...
    private void initComponents() {
        ...
        btnAlumnos5.setForeground(new java.awt.Color(57, 176, 253));
        ...
        pendientes.setText("Lista Colegiatura");
    ...
    private void pendientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pendientesActionPerformed
        // TODO add your handling code here:
        Colegiatura_Lista p=new Colegiatura_Lista();
        p.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Colegiatura_Menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Colegiatura_Menu().setVisible(true);
            }
        });
    }
