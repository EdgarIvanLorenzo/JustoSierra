...
public class Alumnos_Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/lista-de-verificacion-3.png"))); // NOI18N
        nuevo.setText("Lista");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alumnos_Menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alumnos_Menu().setVisible(true);
            }
        });
    }
