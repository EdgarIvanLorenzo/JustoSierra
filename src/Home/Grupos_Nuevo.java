...
public class Grupos_Nuevo extends javax.swing.JFrame {
    Crud crud1=new Crud();
    //Metodo constructor
    public Grupos_Nuevo() {
    ...
    private void initComponents() {
        ...
        grupo.setMaximumRowCount(2);
        grupo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "M", "V", " " }));

        semestre.setBackground(new java.awt.Color(255, 255, 255));
        semestre.setMaximumRowCount(6);
        semestre.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4", "5", "6", " " }));
        semestre.setOpaque(true);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(semestre, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(grupo, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(47, 47, 47))
        );
    ...
    private void btnAlumnos6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlumnos6ActionPerformed
        crud1.addGrupo(Integer.parseInt(semestre.getSelectedItem().toString()), grupo.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Grupos_Nuevo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grupos_Nuevo().setVisible(true);
            }
        });
    }
